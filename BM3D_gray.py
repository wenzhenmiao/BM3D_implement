...
First_Match_threshold = 2500             # Calculated the threshold similarity between blocks
Step1_max_matched_cnt = 16              #  The max matching blocks numbers
...
def Define_SearchWindow(_noisyImg, _BlockPoint, _WindowSize, Blk_Size):
    ...
    LX = point_x+Blk_Size/2-_WindowSize/2     # left top
    LY = point_y+Blk_Size/2-_WindowSize/2     # left bottom
    RX = LX+_WindowSize                       # right top
    RY = LY+_WindowSize                       # right bottom
...
if __name__ == '__main__':
    cv2.setUseOptimized(True)
    img_name = "/Users/marvin/git/BM3D_eval/origin/barbara.png"  
